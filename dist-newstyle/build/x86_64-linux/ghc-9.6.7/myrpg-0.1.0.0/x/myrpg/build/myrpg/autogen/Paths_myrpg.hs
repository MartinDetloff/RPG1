...
getDynLibDir  = catchIO (getEnv "myrpg_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "myrpg_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "myrpg_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "myrpg_sysconfdir") (\_ -> return sysconfdir)
