...
/* package myrpg-0.1.0.0 */
#ifndef VERSION_myrpg
#define VERSION_myrpg "0.1.0.0"
#endif /* VERSION_myrpg */
#ifndef MIN_VERSION_myrpg
#define MIN_VERSION_myrpg(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_myrpg */
...
#define CURRENT_COMPONENT_ID "myrpg-0.1.0.0-inplace-myrpg"
